      ...
      child: GridView(
        ...
        children: <Widget>[
          Statuspannel(
            ...
            backimage: DecorationImage(
              image: AssetImage('images/022-coronavirus.png'),
              colorFilter: ColorFilter.mode(
                  Colors.red.withOpacity(0.40), BlendMode.dstATop),
          ...
          Statuspannel(
            ...
            backimage: DecorationImage(
              image: AssetImage('images/recovered.png'),
              colorFilter: ColorFilter.mode(
                  Colors.blue.withOpacity(0.20), BlendMode.dstATop),
              fit: BoxFit.fitHeight,
            ),
          ),
          Statuspannel(
            ...
            backimage: DecorationImage(
              ...
              colorFilter: ColorFilter.mode(
                  Colors.green.withOpacity(0.20), BlendMode.dstATop),
              fit: BoxFit.fitHeight,
            ),
          ),
          Statuspannel(
            ...
            backimage: DecorationImage(
              image: AssetImage('images/dead.png'),
              colorFilter: ColorFilter.mode(
                  Colors.grey.withOpacity(0.20), BlendMode.dstATop),
              fit: BoxFit.fitHeight,
            ),
          ),
        ],
